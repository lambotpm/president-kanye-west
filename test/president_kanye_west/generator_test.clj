(ns president-kanye-west.generator-test
  (:require [clojure.test :refer :all]
            [president-kanye-west.generator :refer :all]))

(deftest test-word-chain
  (testing "produces a chain of the possible two step transitions between suffixes and prefixes"
